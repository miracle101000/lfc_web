...
class PamphletsList extends StatefulWidget {
  const PamphletsList({super.key});

  @override
  State<PamphletsList> createState() => _PamphletsListState();
}

class _PamphletsListState extends State<PamphletsList> {
